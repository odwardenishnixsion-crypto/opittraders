!(
   ...
   */ (function (t, e) {
    ...
    (() => {
      ...
      var N = {};
      (B.d(N, { default: () => l_ }),
        ((a = m || (m = {})).SVG_NS = "http://www.w3.org/2000/svg"),
        (a.product = "Highcharts"),
        (a.version = "12.5.0"),
        (a.win = "u" > typeof window ? window : {}),
        (a.doc = a.win.document),
        (a.svg = !!a.doc?.createElementNS?.(a.SVG_NS, "svg")?.createSVGRect),
        (a.pageLang = a.doc?.documentElement?.closest("[lang]")?.lang),
        (a.userAgent = a.win.navigator?.userAgent || ""),
        (a.isChrome = a.win.chrome),
        ...
        (a.supportsPassiveEvents = (function () {
          ...
          if (!a.isMS) {
            ...
            a.win.addEventListener &&
              ...
              (a.win.addEventListener("testPassive", a.noop, e),
              a.win.removeEventListener("testPassive", a.noop, e));
          }
          return t;
        })()),
        (a.charts = []),
 ...
 - ${i}: ${e}`),
      ...
      function tr(t, e, i, s) {
        if (
          ((i = i || {}),
          W?.createEvent && (t.dispatchEvent || (t.fireEvent && t !== z)))
        ) {
      ...
      H.jQuery &&
        (H.jQuery.fn.highcharts = function () {
          ...
          if (this[0])
            return t[0]
              ? (new z[G(t[0]) ? t.shift() : "Chart"](this[0], t[0], t[1]),
                this)
              : R[_(this[0], "data-highcharts-chart")];
        });
      let tn = {
          ...
          createElement: function (t, e, i, s, o) {
            ...
            return (
              e && K(r, e),
              o && Q(r, { padding: "0", border: "none", margin: "0" }),
              i && Q(r, i),
              s && s.appendChild(r),
              r
            );
          ...
          insertItem: function (t, e) {
            ...
            for (i = t.options.isInternal ? o : 0; i < o + 1; i++)
              if (
                !e[i] ||
                (V(s) && s < J(e[i].options.index, e[i]._i)) ||
          ...
          normalizeTickInterval: function (t, e, i, s, o) {
            ...
            return te(a * i, -Math.round(Math.log(0.001) / Math.LN10));
          },
          objectEach: ts,
          offset: function (t) {
            ...
            return {
              ...
              left:
                i.left + (H.pageXOffset || e.scrollLeft) - (e.clientLeft || 0),
              width: i.width,
              height: i.height,
            };
          },
        ...
        tM = class {
          ...
          update(t = {}) {
            ((this.dTLCache = {}),
              (this.options = t = tm(!0, this.options, t)));
          ...
          dateFormat(t, e, i) {
            ...
            if (tf(t) && -1 !== t.indexOf("%")) {
              ...
              let i = (this.getTimezoneOffset(e) || 0) / 36e5,
                ...
                { prefix: o = "", suffix: r = "" } = t;
              t = o + this.dateTimeFormat(tp({ timeZone: s }, t), e) + r;
            }
            return i ? tk(t) : t;
          }
          resolveDTLFormat(t) {
            return tu(t, !0)
              ? tu(t, !0) && void 0 === t.main
                ? { main: t }
                : t
              : { main: (t = tb(t))[0], from: t[1], to: t[2] };
          }
        ...
        { defined: tS, extend: tT, timeUnits: tC } = tn,
        tA = class extends tM {
          getTimeTicks(t, e, i, s) {
            ...
            if ((s ?? (s = 1), tS(e))) {
              if (
                ((f = h >= tC.second ? 0 : n * Math.floor(f / n)),
                h >= tC.second &&
                  (u = h >= tC.minute ? 0 : n * Math.floor(u / n)),
                h >= tC.minute &&
                  (g = h >= tC.hour ? 0 : n * Math.floor(g / n)),
                h >= tC.hour && (p = h >= tC.day ? 0 : n * Math.floor(p / n)),
                h >= tC.day &&
                  (c = h >= tC.month ? 1 : Math.max(1, n * Math.floor(c / n))),
                h >= tC.month && (d = h >= tC.year ? 0 : n * Math.floor(d / n)),
                h >= tC.year && (l -= l % n),
                h === tC.week)
              ) {
            ...
            return ((r.info = tT(t, { higherRanks: a, totalRange: h * n })), r);
          }
        },
        { isTouchDevice: tP } = z,
        { fireEvent: tL, merge: tO } = tn,
        tE = {
          colors: [
            "#2caffe",
            "#544fc5",
        ...
        tD = {
          ...
          setOptions: function (t) {
            return (
              tL(z, "setOptions", { options: t }),
              tO(!0, tE, t),
              t.time && tI.update(tE.time),
              t.lang &&
                "locale" in t.lang &&
                tI.update({ locale: t.lang.locale }),
              t.lang?.chartTitle &&
                (tE.title = { ...tE.title, text: t.lang.chartTitle }),
              tE
            );
          },
        },
        { win: tB } = z,
        { isNumber: tN, isString: tz, merge: tR, pInt: tW, defined: tH } = tn,
      ...
      class tG {
        ...
        constructor(t) {
          ...
          if ("object" == typeof t && void 0 !== t.stops)
            this.stops = t.stops.map((t) => new tG(t[1]));
          else if ("string" == typeof t)
            for (
              this.input = t = tG.names[t.toLowerCase()] || t,
                s = tG.parsers.length;
              s-- && !i;
            )
              (e = (o = tG.parsers[s]).regex.exec(t)) && (i = o.parse(e));
          i && (this.rgba = i);
        }
        get(t) {
          let e = this.input,
        ...
        tweenTo(t, e) {
          let i = this.rgba,
            s = t.rgba;
          if (!tN(i[0]) || !tN(s[0]))
            return tG.useColorMix && tF(this.input) && tF(t.input) && e < 0.99
              ? tX(this.input, t.input, e)
              : t.input || "none";
          let o = 1 !== s[3] || 1 !== i[3],
            r = (t, s) => t + (i[s] - t) * (1 - e),
      ...
      ((tG.names = { white: "#ffffff", black: "#000000" }),
        (tG.parsers = [
          {
            regex:
          ...
          },
          {
            ...
            parse: function (t) {
              return [
                ...
                tW(t[2], 16),
                tW(t[3], 16),
                tH(t[4]) ? tW(t[4], 16) / 255 : 1,
              ];
            },
          },
        ]),
        (tG.useColorMix = tB.CSS?.supports(
          "color",
      ...
      class tV {
        ...
        run(t, e, i) {
          let s = this,
            ...
            a =
              tj.requestAnimationFrame ||
              function (t) {
                setTimeout(t, 13);
              },
            n = function () {
              for (let t = 0; t < tV.timers.length; t++)
                tV.timers[t]() || tV.timers.splice(t--, 1);
        ...
        strokeSetter() {
          this.elem.attr(
            this.prop,
            tY(this.start).tweenTo(tY(this.end), this.pos),
            void 0,
            !0,
          );
        }
      ...
      function t3(t, e) {
        ...
        for (; i--; )
          tV.timers[i].elem !== t ||
            (e && e !== tV.timers[i].prop) ||
            (tV.timers[i].stopped = !0);
      }
      let t5 = {
        ...
        ea =
          er &&
          ee(er.createPolicy) &&
          er.createPolicy("highcharts", { createHTML: (t) => t }),
        en = ea ? ea.createHTML("") : "";
      class eh {
        static filterUserAttributes(t) {
          return (
            es(t, (e, i) => {
              let s = !0;
              (-1 === eh.allowedAttributes.indexOf(i) && (s = !1),
                -1 !==
                  ...
                  (s =
                    ei(e) &&
                    eh.allowedReferences.some((t) => 0 === e.indexOf(t))),
                s ||
                  (et(33, !1, void 0, {
                    "Invalid attribute in config": `${i}`,
                  }),
                  delete t[i]),
                ei(e) && t[i] && (t[i] = e.replace(/</g, "&lt;")));
            }),
            t
          );
        }
        ...
        addToDOM(t) {
          return (function t(e, i) {
            let s;
            return (
              eo(e).forEach(function (e) {
                let o,
                  r = e.tagName,
                  a = e.textContent
                    ? z.doc.createTextNode(e.textContent)
                    : void 0,
                ...
                if (r)
                  if ("#text" === r) o = a;
                    ...
                    (es(e, function (t, e) {
                      ...
                      t4(h, n ? l : eh.filterUserAttributes(l)),
                      e.style && t7(h, e.style),
                      a && h.appendChild(a),
                      t(e.children || [], h),
                      (o = h));
                  } else et(33, !1, void 0, { "Invalid tagName in config": r });
      ...
      ((eh.allowedAttributes = [
        ...
        (eh.emptyHTML = en),
        (eh.bypassHTMLFiltering = !1));
      let { defaultOptions: el, defaultTime: ed } = tD,
        { pageLang: ec } = z,
        {
          extend: ep,
      ...
      function eM(t, e, i, s) {
        ...
        return (
          (o = (ek[u] ?? (ek[u] = new Intl.NumberFormat(g, c))).format(t)),
          p &&
            (o = o
              .replace(/([,\.])/g, "_$1")
              .replace(/_\,/g, s ?? ",")
      ...
      (((n = x || (x = {})).rendererTypes = {}),
        (n.getRendererType = function (t = o) {
      ...
      let eT = x,
        { clamp: eC, pick: eA, pushUnique: eP, stableSort: eL } = tn;
          ...
          for (c = e.length; c--; )
            ((f = e[c]),
              (m =
                ...
                2),
              (f.pos = eC(m - f.size * f.align, 0, i - f.size)));
      ...
      let eO = y,
        { animate: eE, animObject: eI, stop: eD } = t5,
        {
          deg2rad: eB,
          doc: eN,
          svg: ez,
      ...
      class e7 {
        ...
        align(t, e, i, s = !0) {
          ...
          let h = e3(i, o[n], o),
            l =
              (h.x || 0) +
              (t.x || 0) +
              ((h.width || 0) - (t.width || 0)) * e_(t.align),
            d =
              (h.y || 0) +
              (t.y || 0) +
              ((h.height || 0) - (t.height || 0)) * e_(t.verticalAlign),
            c = {};
          return (
        ...
        applyTextOutline(t) {
          ...
          if (o && "none" !== o && z.svg) {
            ...
            ((a.textContent = "​"),
              eF(a, { x: Number(e.getAttribute("x")), dy: -r }),
              t.appendChild(a),
        ...
        clip(t) {
          if (t && !t.clipPath) {
            ...
            (eV(t, { clipPath: i, id: e, count: 0 }), t.add(i));
          }
          return this.attr(
            "clip-path",
        ...
        crisp(t, e) {
          ...
          let i = t.x || this.x || 0,
            ...
            n = eY(s, e);
          return (
            eV(t, { x: a, y: n, width: eY(o, e) - a, height: eY(r, e) - n }),
            eU(t.strokeWidth) && (t.strokeWidth = e),
            t
          );
        }
        complexColor(t, e, i) {
            ...
            (e && (t = eV(e, i)),
              null === t.width || "auto" === t.width
                ...
                : "text" === s.nodeName.toLowerCase() &&
                  t.width &&
                  (o = this.textWidth = e5(t.width)),
              eV(this.styles, t),
              o && !ez && this.renderer.forExport && delete t.width);
        ...
        destroy() {
          ...
          for (t.safeRemoveChild(e); r?.div && 0 === r.div.childNodes.length; )
            ((a = r.parentGroup),
              ...
              delete r.div,
              (r = a));
          (t.alignOptions && e$(i.alignedObjects, t),
            e2(t, (e, i) => {
              ((t[i]?.parentGroup === t ||
        ...
        getBBox(t, e) {
          let i,
            ...
            g = a.styledMode
              ? r && e7.prototype.getStyle.call(r, "font-size")
              : n.fontSize,
        ...
        constructor(t, e) {
          ((this.onEvents = {}),
            ...
            (this.element =
              "span" === e || "body" === e
                ? eG(e)
                : eN.createElementNS(this.SVG_NS, e)),
            (this.renderer = t),
            (this.styles = {}),
            eZ(this, "afterInit"));
        }
        ...
        strokeWidth() {
          ...
          return (
            /px$/.test(t)
              ? (e = e5(t))
              : "" !== t &&
                (eF((i = eN.createElementNS(eR, "rect")), {
                  width: t,
                  "stroke-width": 0,
                }),
        ...
        updateTransform(t = "transform") {
          ...
          (eU(s) && g.push("matrix(" + s.join(",") + ")"),
            ...
            (eU(h) || eU(l)) && g.push(`scale(${h ?? 1} ${l ?? 1})`),
            g.length &&
              !(d || this).textPath &&
          ...
          if (
            (eU(t)
              ? (r.setAttribute("data-z-index", t),
                (t *= 1),
                this[e] === t && (p = !1))
              : eU(this[e]) && r.removeAttribute("data-z-index"),
            (this[e] = t),
            p)
          ) {
            for (
              ...
              ((c = !eU((l = (h = n[g]).getAttribute("data-z-index")))),
                h !== r &&
                  (t < 0 && c && !a && !g
      ...
      ((e7.symbolCustomAttribs = [
        ...
        (e7.prototype.strokeSetter = e7.prototype.fillSetter),
        (e7.prototype.yGetter = e7.prototype.xGetter),
        (e7.prototype.matrixSetter =
          e7.prototype.rotationOriginXSetter =
          e7.prototype.rotationOriginYSetter =
          e7.prototype.rotationSetter =
          e7.prototype.scaleXSetter =
          e7.prototype.scaleYSetter =
          e7.prototype.translateXSetter =
          e7.prototype.translateYSetter =
          e7.prototype.verticalAlignSetter =
            function (t, e) {
      ...
      class il extends it {
        ...
        alignSetter(t) {
          ...
          ((this.textAlign = t),
            e !== this.alignFactor &&
              ((this.alignFactor = e),
              this.bBox && io(this.xSetting) && this.attr({ x: this.xSetting }),
        ...
        destroy() {
          (ih(this.element, "mouseenter"),
            ih(this.element, "mouseleave"),
        ...
        updateBoxSize() {
          let t,
            ...
            s = this.padding,
            o = (this.bBox =
              (!io(this.widthSetting) ||
                !io(this.heightSetting) ||
                this.textAlign) &&
              ie(e.textStr)
                ? e.getBBox(void 0, 0)
                : il.emptyBBox);
          ...
          if (
            ...
            ((i.x = t = this.getCrispAdjust()),
              ...
              this.box.attr(ii(i, this.deferredAttr)),
              (this.deferredAttr = {}));
          }
        }
        updateTextPadding() {
      ...
      ((il.emptyBBox = { width: 0, height: 0, x: 0, y: 0 }),
        (il.textProps = [
          "color",
          "direction",
          "fontFamily",
          ...
          ((b.params = { start: a, end: n, cx: t, cy: e }),
            ...
            id(p) &&
              (((b = [
                ...
                0,
                y,
                id(o.clockwise) ? 1 - o.clockwise : 0,
                t + p * u,
                e + p * f,
          ...
          modifyDOM() {
            ...
            [].forEach.call(
              ...
              (t, s) => {
                t.nextSibling &&
                  ...
                  ik(t, { dy: this.getLineHeight(t.nextSibling), x: i }));
              },
            );
            let s = this.width || 0;
            if (!s) return;
            let o = (t, o) => {
                ...
                if (n) {
                  ...
                  this.ellipsis &&
                    r &&
                    this.truncate(t, r, void 0, 0, s, l, iA);
              },
              r = (t) => {
                [].slice.call(t.childNodes).forEach((i) => {
                  i.nodeType === iv.Node.TEXT_NODE
                    ? o(i, t)
          ...
          modifyTree(t) {
            let e = (i, s) => {
              ...
              ("#text" !== n && "a" !== n && (i.tagName = "tspan"),
                iw(i, { attributes: o, style: a }),
                r && r.filter((t) => "#text" !== t.tagName).forEach(e));
            };
            (t.forEach(e),
              iM(this.svgElement, "afterModifyTree", { nodes: t }));
          }
          truncate(t, e, i, s, o, r, a) {
            ...
            if (((l.rotation = 0), s + (h = f(t.textContent.length)) > o)) {
              ...
              (0 === g
                ...
                this.ellipsis &&
                  h > o &&
                  this.truncate(t, t.textContent || "", void 0, 0, o, r, iA));
            }
      ...
      class i3 {
        constructor(t, e, i, s, o, r, a) {
          ...
          (a || l.css(this.getStyle(s || {})),
            t.appendChild(d),
            iF(t, "dir", "ltr"),
            -1 === t.innerHTML.indexOf("xmlns") && iF(d, "xmlns", this.SVG_NS),
            (this.box = d),
            (this.boxWrapper = l),
            (this.alignedObjects = []),
            ...
            this.createElement("desc")
              .add()
              .element.appendChild(
                iI.createTextNode("Created with Highcharts 12.5.0"),
              ),
        ...
        getReferenceURL() {
          if ((iD || iN) && iI.getElementsByTagName("base").length) {
            if (!iU(e)) {
              ...
              ij(i, { position: "fixed", top: 0, left: 0, zIndex: 9e5 });
              let s = iI.elementFromPoint(6, 6);
              ((e = s?.id === "hitme"), iI.body.removeChild(i));
            }
            if (e)
              return i1(
                iH.location.href.split("#")[0],
                [/<[^>]*>/g, ""],
                [/([\('\)])/g, "\\$1"],
                [/ /g, "%20"],
              );
          ...
          return (
            c ||
              ["hover", "select", "disabled"].forEach((t, e) => {
                (m.push(
                  iJ(m[0], eh.filterUserAttributes(p[e + 5] || u[t] || {})),
                ),
                  x.push(m[e + 1].style),
                  delete m[e + 1].style);
              }),
        ...
        crispLine(t, e) {
          let [i, s] = t;
          return (
            iU(i[1]) && i[1] === s[1] && (i[1] = s[1] = iY(i[1], e)),
            iU(i[2]) && i[2] === s[2] && (i[2] = s[2] = iY(i[2], e)),
            t
          );
        }
        path(t) {
          ...
          return (
            iZ(t) ? (e.d = t) : iq(t) && iV(e, t),
            this.createElement("path").attr(e)
          );
        }
        circle(t, e, i) {
          let s = iq(t) ? t : void 0 === t ? {} : { x: t, y: e, r: i },
        ...
        rect(t, e, i, s, o, r) {
          ...
          return (
            this.styledMode ||
              (void 0 !== r && ((a["stroke-width"] = r), iV(a, n.crisp(a))),
              (a.fill = "none")),
            (n.rSetter = function (t, e, i) {
              ((n.r = t), iF(i, { rx: t, ry: t }));
            }),
            (n.rGetter = function () {
              return n.r || 0;
            }),
        ...
        symbol(t, e, i, s, o, r) {
          ...
          if (u)
            ...
            ((s.imgwidth = iQ(r?.width, iW[h]?.width)),
              (s.imgheight = iQ(r?.height, iW[h]?.height)),
                ...
                : (s.attr({ width: 0, height: 0 }),
                  iG("img", {
                    onload: function () {
                      ...
                      (0 === this.width &&
                        (ij(this, { position: "absolute", top: "-999em" }),
                        iI.body.appendChild(this)),
                        (iW[h] = { width: this.width, height: this.height }),
        ...
        fontMetrics(t) {
          let e = i_(t)
              ? t
              : i0(it.prototype.getStyle.call(t, "font-size") || 0),
        ...
        rotCorr(t, e, i) {
          let s = t;
          return (
            e && i && (s = Math.max(s * Math.cos(e * iE), 4)),
            { x: (-t / 3) * Math.sin(e * iE), y: s }
          );
        }
        pathToSegments(t) {
          let e = [],
      ...
      let { composed: i5, isFirefox: i6 } = z,
        {
          attr: i9,
          css: i4,
          createElement: i8,
      ...
      function sr(t, e, i) {
        ...
        (it.prototype[`${e}Setter`].call(this, t, e, i),
          s && (i.style[e] = s[e] = t));
      }
      let sa = (t, e) => {
        if (!t.div) {
          ...
          ((t.classSetter = (t, e, i) => {
            ...
            (t.opacitySetter = t.visibilitySetter = sr),
            (t.css = (e) => (
              s.call(t, e),
      ...
      class sn extends it {
        ...
        css(t) {
          let e,
            ...
            o = s && t.width;
          return (
            s && (delete t.width, (this.textWidth = ss(o) || void 0), (e = !0)),
            ...
            t?.lineClamp &&
              ...
              (t.overflow = "hidden")),
            si(Number(t?.fontSize)) && (t.fontSize += "px"),
            st(this.styles, t),
            i4(i, t),
        ...
        updateTransform() {
          ...
          let {
            ...
            x = () =>
              this.textPxLength
                ? this.textPxLength
                : (i4(t, { width: "", whiteSpace: d || "nowrap" }),
                  t.offsetWidth);
          if (
            (e || i4(t, { marginLeft: `${g}px`, marginTop: `${u}px` }),
            "SPAN" === t.tagName)
          ) {
            let g,
            ...
            (e &&
              (i4(t, { display: "inline-block", verticalAlign: "top" }),
              ...
              u !== this.cTT &&
                ...
                this.getSpanCorrection(
                  (!i7(o) && !this.textWidth && this.textPxLength) ||
                    t.offsetWidth,
                  g,
                  se(c),
                )));
                ...
                ? (super.updateTransform(),
                  si(f) && si(m)
                    ? (e.attr({
                      ...
                      i4(t, { display: l, textAlign: c }))
                    : i6 && e.attr({ width: 0, height: 0 }))
                : i4(t, k),
              (this.cTT = u),
              (this.oldRotation = o),
              (this.oldAlign = c));
        ...
        textSetter(t) {
          t !== this.textStr &&
            ...
            eh.setElementHTML(this.element, t ?? ""),
            (this.textStr = t),
            (this.doTransform = !0));
        }
        alignSetter(t) {
      ...
      let sh = sn.prototype;
      ((sh.visibilitySetter = sh.opacitySetter = sr),
        (sh.ySetter =
          sh.rotationSetter =
          sh.rotationOriginXSetter =
          sh.rotationOriginYSetter =
            sh.xSetter),
        ((h = b || (b = {})).xAxis = {
          alignTicks: !0,
      ...
      let sl = b,
        { addEvent: sd, isFunction: sc, objectEach: sp, removeEvent: sg } = tn;
      (v || (v = {})).registerEventOptions = function (t, e) {
        ((t.eventOptions = t.eventOptions || {}),
          sp(e.events, function (e, i) {
            t.eventOptions[i] !== e &&
              (t.eventOptions[i] &&
                (sg(t, i, t.eventOptions[i]), delete t.eventOptions[i]),
              sc(e) && ((t.eventOptions[i] = e), sd(t, i, e, { order: 0 })));
          }));
      };
      let su = v,
        { deg2rad: sf } = z,
        ...
        sA = class {
          ...
          getPosition(t, e, i, s) {
            let o = this.axis,
              ...
              n = {
                x: t
                  ? sx(o.translate(e + i, void 0, void 0, s) + o.transB)
                  : o.left +
                    o.offset +
                    (o.opposite
                ...
                y: t
                  ...
                  : sx(a - o.translate(e + i, void 0, void 0, s) - o.transB),
              };
            return (
              (n.y = sm(n.y, -1e9, 1e9)),
              sk(this, "afterGetPosition", { pos: n }),
              n
            );
          }
            ...
            return (
              (h =
                0 === d.side
                  ...
                  : 2 === d.side
                    ? u.y + m
                    : Math.cos(i.rotation * sf) *
                      (u.y - i.getBBox(!1, 0).height / 2)),
              sy(o.y) && (h = 0 === d.side && d.horiz ? o.y + h : o.y),
              (t =
                t +
                sC(o.x, [0, 1, 0, -1][d.side] * m) +
                f +
                u.x -
                (r && s ? r * c * (p ? -1 : 1) : 0)),
          ...
          handleOverflow(t) {
            ...
            (l || "justify" !== i.overflow
              ? l < 0 && s - d * c < a
                ? (f = Math.round(s / Math.cos(l * sf) - a))
                : l > 0 &&
                  s + d * c > n &&
                  (f = Math.round((o - s) / Math.cos(l * sf)))
              : (s - d * c < a
                  ? (g = t.x + g * (1 - d) - a)
        ...
        { animObject: sP } = t5,
        { xAxis: sL, yAxis: sO } = sl,
        { defaultOptions: sE } = tD,
        { registerEventOptions: sI } = su,
        { deg2rad: sD } = z,
        {
          arrayMax: sB,
          arrayMin: sN,
        ...
        s3 = (t, e) =>
          sq(
            ...
            void 0,
            void 0,
            sJ(t.options.allowDecimals, e < 0.5 || void 0 !== t.tickAmount),
            !!t.tickAmount,
          );
      ...
      class s5 {
        ...
        init(t, e, i = this.coll) {
          ...
          ((this.chart = t),
            ...
            (this.isXAxis = s),
            (this.coll = i),
            sY(this, "init", { userOptions: e }),
            (this.opposite = sJ(e.opposite, this.opposite)),
            (this.side = sJ(
              e.side,
              this.side,
          ...
          ((this.crosshair = !0 === n ? {} : n),
            ...
            t.inverted &&
              ...
              !sW(this.reversed) &&
              (this.reversed = !0),
            (this.labelRotation = sV(a.rotation) ? a.rotation : void 0),
            sI(this, r),
            sY(this, "afterInit"));
        }
        setOptions(t) {
          ...
          ((this.options = s_(
            ...
            sY(this, "afterSetOptions", { userOptions: t }));
        }
                  ...
                  if (
                    ...
                    (o = i.getColumn("x")).length &&
                      ...
                      sV(a) ||
                        ...
                        (n = t.max)),
                      o.length &&
                        ((e.dataMin = Math.min(sJ(e.dataMin, a), a)),
                        (e.dataMax = Math.max(sJ(e.dataMax, n), n))));
                  else {
        ...
        getPlotLinePath(t) {
          ...
          return (
            sY(this, "getPlotLinePath", b, function (t) {
              ((g = f =
                (c = sz(
                  (c = sJ(c, e.translate(a, void 0, void 0, r))),
                  -1e9,
                  1e9,
                )) + d),
                (u = m = h - c - d),
        ...
        adjustForMinRange() {
          ...
          (this.isXAxis &&
            ...
            !e &&
            (r =
              sW(t.min) || sW(t.max) || sW(t.floor) || sW(t.ceiling)
                ? null
                : Math.min(
                    5 *
                      (sj(
        ...
        setAxisTranslation() {
          ...
          ((o || s || r) &&
            ...
            sY(this, "afterSetAxisTranslation"));
        }
        minFromRange() {
        ...
        setTickInterval(t) {
          let {
            ...
            d = i.time,
            c = sV(this.threshold) ? this.threshold : void 0,
            p = this.minRange || 0,
            { ceiling: g, floor: u, linkedTo: f, softMax: m, softMin: x } = h,
            y = sV(f) && i[this.coll]?.[f],
            ...
            M,
            S =
              sV(h.tickInterval) && h.tickInterval >= 0
                ? h.tickInterval
                : void 0,
            T,
            C,
          ...
          if (
            ...
            (A = sJ(this.userMin, d.parse(h.min))),
            (P = sJ(this.userMax, d.parse(h.max))),
            y
              ? ((this.linkedParent = y),
                (M = y.getExtremes()),
                (this.min = sJ(M.min, M.dataMin)),
                (this.max = sJ(M.max, M.dataMax)),
                this.type !== y.type && sF(11, !0, i))
              : (l &&
                  sW(c) &&
                  sV(s) &&
                  sV(o) &&
            ...
            sV(this.max) &&
              ...
              (n &&
                (this.positiveValuesOnly &&
                  !t &&
                  0 >= Math.min(this.min, sJ(o, this.min)) &&
                  sF(10, !0, i),
                (this.min = sR(n.log2lin(this.min), 16)),
                (this.max = sR(n.log2lin(this.max), 16))),
              this.range &&
                sV(o) &&
                ((this.userMin =
                  this.min =
                ...
                (this.range = void 0))),
            sY(this, "foundExtremes"),
            this.adjustForMinRange(),
            sV(this.min) && sV(this.max))
          ) {
            if (
              (!sV(this.userMin) && sV(x) && x < this.min && (this.min = A = x),
              !sV(this.userMax) && sV(m) && m > this.max && (this.max = P = m),
              e ||
                this.axisPointRange ||
                ...
                ((w = this.max - this.min) &&
                  (!sW(A) && k && (this.min -= w * k),
                  !sW(P) && v && (this.max += w * v))),
              !sV(this.userMin) && sV(u) && (this.min = Math.max(this.min, u)),
              !sV(this.userMax) && sV(g) && (this.max = Math.min(this.max, g)),
              l && sV(o) && sV(s))
            ) {
              let t = c || 0;
              !sW(A) && this.min < t && o >= t
            ...
            (!i.polar &&
              ...
              (sW(h.min)
                ? (this.max = this.min)
                : sW(h.max) && (this.min = this.max)),
              (w = this.max - this.min));
          }
          if (
            (this.min !== this.max && sV(this.min) && sV(this.max)
              ? y && !S && b === y.options.tickPixelInterval
                ? (this.tickInterval = S = y.tickInterval)
                : (this.tickInterval = sJ(
                    S,
                    this.tickAmount
            ...
            (this.series.forEach(function (e) {
              ...
              sY(this, "postProcessData", { hasExtremesChanged: t }));
          }
          (this.setAxisTranslation(),
            sY(this, "initialAxisTranslation"),
            this.pointRange &&
              !S &&
          ...
          (!S && L && this.tickInterval < L && (this.tickInterval = L),
            r || n || S || (this.tickInterval = s3(this, this.tickInterval)),
        ...
        setTickPositions() {
          ...
          if (
            ...
            if (
              ...
              ((n = [this.min, this.max]), sF(19, !1, this.chart));
              ...
              for (; e <= 2 * t; )
                if (
                  ...
                  this.tickInterval = s3(this, (e *= 1.1));
                else break;
            }
            (n.length > this.len &&
        ...
        setExtremes(t, e, i = !0, s, o) {
          ...
          (this.series.forEach((t) => {
            ...
            (t = r.time.parse(t)),
            (e = r.time.parse(e)),
            sY(this, "setExtremes", (o = sG(o, { min: t, max: e })), (t) => {
              ((this.userMin = t.min),
                (this.userMax = t.max),
                (this.eventArgs = t),
                i && r.redraw(s));
        ...
        setAxisSize() {
          let t = this.chart,
            ...
            o = (this.width = Math.round(
              sQ(sJ(e.width, t.plotWidth - i[3] + i[1]), t.plotWidth),
            )),
            r = (this.height = Math.round(
              sQ(sJ(e.height, t.plotHeight - i[0] + i[2]), t.plotHeight),
            )),
            a = (this.top = Math.round(
              sQ(sJ(e.top, t.plotTop + i[0]), t.plotHeight, t.plotTop),
            )),
            n = (this.left = Math.round(
              sQ(sJ(e.left, t.plotLeft + i[3]), t.plotWidth, t.plotLeft),
            ));
        ...
        autoLabelAlign(t) {
          let e = (((t - 90 * this.side) % 360) + 360) % 360,
            i = { align: "center" };
          return (
            sY(this, "autoLabelAlign", i, function (t) {
              e > 15 && e < 165
                ? (t.align = "right")
        ...
        unsquish() {
          ...
          return (
            (this.autoRotation = p),
            (this.labelRotation = sJ(d, sV(r) ? r : 0)),
            t.step ? s : l
          );
        }
        getSlotWidth(t) {
              ...
              i &&
                ...
                e.shortenLabel
                  ...
                  : p &&
                    ...
                    ? i.css(sG(a, { width: `${p}px`, lineClamp: g }))
                    : !i.styles.width ||
                      a.width ||
                      o ||
                      i.css({ width: "auto" }),
        ...
        addTitle(t) {
          ...
          (this.axisTitle ||
            ...
            a || this.axisTitle.css(s_(r.style)),
          ...
          if (
            ...
            d?.text &&
              ...
              m &&
                ...
                (b = sW((y = d.offset)) ? 0 : sJ(d.margin, i ? 5 : 10)))),
            t.renderLine(),
            (t.offset = f * sJ(s.offset, g[o] ? g[o] + (s.margin || 0) : 0)),
            ...
            v &&
              ...
              (k +=
                f *
                (i
                  ? sJ(c.y, t.tickRotCorr.y + f * c.distance)
                  : sJ(c.x, f * c.distance)))),
            (t.axisTitleMargin = sJ(y, k)),
        ...
        getTitlePosition(t) {
          ...
          return (sY(this, "afterGetTitlePosition", { titlePosition: f }), f);
        }
        renderMinorTick(t, e) {
                ...
                h.forEach(function (r, a) {
                  ((e = void 0 !== h[a + 1] ? h[a + 1] + m : i.max - m),
                    a % 2 == 0 &&
                      r < i.max &&
                      e <= i.max + (s.polar ? -m : m) &&
                      (p[r] || (p[r] = new z.PlotLineOrBand(i, {})),
                      (t = r + m),
                      (p[r].options = {
        ...
        drawCrosshair(t, e) {
          let i = this.crosshair,
            ...
            l;
          if (
            (sY(this, "drawCrosshair", { e: t, point: e }),
            t || (t = this.cross?.e),
            i && !1 !== (sW(e) || !s))
          ) {
            if (
                  ...
                  (h
                    .attr({
                      stroke:
                        i.color ||
                        (n
                          ? tG.parse("#ccd3ff").setOpacity(0.25).get()
                          : "#cccccc"),
          ...
          sY(this, "afterDrawCrosshair", { e: t, point: e });
        }
        hideCrosshair() {
        ...
        class s {
          ...
          normalizeTimeTickInterval(t, e) {
            ...
            for (
              ...
              ((o = s8[(s = i[a])[0]]),
              (r = s[1]),
              !i[a + 1] || !(t <= (o * r[r.length - 1] + s8[i[a + 1][0]]) / 2));
              a++
            );
      ...
      let s7 = k,
        { addEvent: ot, normalizeTickInterval: oe, pick: oi } = tn;
      !(function (t) {
        function e() {
      ...
      let os = w,
        { erase: oo, extend: or, isNumber: oa } = tn;
      !(function (t) {
        let e;
        function i(t) {
      ...
      class oy {
        ...
        renderLabel(t, e, i, s) {
          ...
          let h = e.xBounds || [e[0][1], e[1][1], i ? e[2][1] : e[0][1]],
            ...
            c = od(l),
            p = ol(h) - d;
          (n.align(t, !1, { x: d, y: c, width: p, height: ol(l) - c }),
            (n.alignAttr.y -= r.fontMetrics(n).b),
            (!n.alignValue || "left" === n.alignValue || oc(a)) &&
              n.css({
                width:
                  (t.style?.width ||
                    (i && a
      ...
      let { animObject: ob } = t5,
        { format: ov } = eS,
        { composed: ok, dateFormats: ow, doc: oM, isSafari: oS } = z,
        { distribute: oT } = eO,
        {
          addEvent: oC,
          clamp: oA,
      ...
      class oY {
        ...
        destroy() {
          (this.label && (this.label = this.label.destroy()),
            ...
            this.renderer &&
              ((this.renderer = this.renderer.destroy()), oO(this.container)),
            oL(this.hideTimer));
        }
        getAnchor(t, e) {
          let i,
        ...
        getClassName(t, e, i) {
          ...
          return [
            ...
            !i && "highcharts-color-" + oH(t.colorIndex, o.colorIndex),
            r?.className,
          ]
            .filter(oR)
            .join(" ");
        ...
        getLabel({ anchorX: t, anchorY: e } = { anchorX: 0, anchorY: 0 }) {
          ...
          if (!this.label) {
            if (this.outside) {
              ...
              ((this.container = a = z.doc.createElement("div")),
                (a.className =
          ...
          return (
            a && !a.parentElement && z.doc.body.appendChild(a),
            this.label
          );
        }
        getPlayingField() {
          let { body: t, documentElement: e } = oM,
        ...
        hide(t) {
          let e = this;
          (oL(this.hideTimer),
            (t = oH(t, this.options.hideDelay)),
            this.isHidden ||
              (this.hideTimer = oG(function () {
                let i = e.getLabel();
                (e.getLabel().animate(
                  { opacity: 0 },
                  {
        ...
        move(t, e, i, s) {
          let { followPointer: o, options: r } = this,
            a = ob(!o && !this.isHidden && !r.fixed && r.animation),
            n = o || (this.len || 0) > 1,
            h = { x: t, y: e };
          (n
        ...
        refresh(t, e) {
          ...
          n.points = void 0;
          let m = n.series;
          if (((this.distance = oH(m.tooltipOptions.distance, 16)), !1 === f))
            this.hide();
          else {
        ...
        renderSplit(t, e) {
          let i = this,
            ...
            v =
              i.outside && "number" != typeof d
                ? oM.documentElement.getBoundingClientRect()
          ...
          oS && k.attr({ opacity: 1 === k.opacity ? 0.999 : 1 });
        }
        drawTracker() {
          let t = this;
          ...
          ((r[0] += e.plotLeft - (i.translateX || 0)),
            ...
            t.tracker
              ...
              : ((t.tracker = i.renderer
                  ...
                  .add(i)),
                oC(t.tracker.element, "mouseenter", () => {
                  oL(t.hideTimer);
                }),
                e.styledMode || t.tracker.attr({ fill: "rgba(0,0,0,0)" })));
        }
        styledModeFormat(t) {
          return t
        ...
        headerFooterFormatter(t, e) {
          ...
          return (
            oI(this, "headerFormatter", a, function (e) {
              if (
                (r &&
                  !n &&
                  oN(t.key) &&
        ...
        updatePosition(t) {
          ...
          if (a && i) {
            ...
            ((b = (o.borderWidth || 0) + 2 * s + 2),
              a.setSize(
                oA(h + b, 0, m.documentElement.clientWidth) - 1,
                n + b,
                !1,
              ),
              (1 !== g || 1 !== u) &&
                (oP(i, { transform: `scale(${g}, ${u})` }), (x *= g), (y *= u)),
              (x += c - f.x),
              (y += p - f.y));
          }
      ...
      (l = oY || (oY = {})).compose = function (t) {
        oX(ok, "Core.Tooltip") &&
          oC(t, "afterInit", function () {
            let t = this.chart;
            t.options.tooltip &&
              (t.tooltip = new l(t, t.options.tooltip, this));
          });
      };
      let oj = oY,
        { animObject: oU } = t5,
      ...
      class o7 {
        ...
        applyOptions(t, e) {
          ...
          return (
            oK(this, (t = o7.prototype.optionsToObject.call(this, t))),
            (this.options = this.options ? oK(this.options, t) : t),
            t.group && delete this.group,
            t.dataLabels && delete this.dataLabels,
            s && (this.y = o7.prototype.getNestedProperty.call(this, s)),
            ...
            void 0 === this.x && i
              ...
              : o2(t.x) && i.options.relativeXValue
            ...
            let t = this,
              ...
              a = () => {
                for (let e in ((t.graphic ||
                  ...
                  t.dataLabel ||
                  t.dataLabels) &&
                  (o4(t), t.destroyElements()),
                t))
                  delete t[e];
              };
            (t.legendItem && i.legend.destroyItem(t),
              o && (t.setState(), oq(o, t), o.length || (i.hoverPoints = null)),
              t === i.hoverPoint && t.onMouseOut(),
              s?.enabled
                ? (this.animateBeforeDestroy(), o9(a, r.duration))
                : a(),
              i.pointCount--);
          }
          this.destroyed = !0;
        ...
        getNestedProperty(t) {
          if (t)
            return 0 === t.indexOf("custom.") ? oQ(t, this.options) : this[t];
        }
        getZone() {
          let t = this.series,
            e = t.zones,
        ...
        optionsToObject(t) {
          ...
          if (o2(t) || null === t) r[s[0]] = t;
            ...
            for (
              ...
              ((i && void 0 === t[n]) ||
                (s[h].indexOf(".") > 0
                  ? o7.prototype.setNestedProperty(r, t[n], s[h])
                  : (r[s[h]] = t[n])),
                n++,
                h++);
          else
        ...
        resolveColor() {
          ...
          (delete this.nonZonedColor,
            ...
            (this.colorIndex = o6(this.options.colorIndex, a)),
            (this.color = o6(this.options.color, s)));
        }
        ...
        update(t, e, i, s) {
          ...
          function d() {
            ...
            (a.dataTable.setRow(c, o),
              (l.data[o] =
                o3(l.data[o], !0) || o3(t, !0) ? r.options : o6(t, l.data[o])),
        ...
        manageEvent(t) {
          ...
          (!this.hcEvents?.[t] ||
            ...
            ? (this.importedUserEvent?.(),
              (this.importedUserEvent = oZ(this, t, i)),
          ...
          if (
            ...
            if (
              ...
              ((u = i.pointAttribs(this, t)),
                (f = o6(d.options.chart.animation, o.animation)));
              let e = u.opacity;
            ...
            (g &&
              this.graphic.animate(
                g,
                o6(d.options.chart.animation, n.animation, r.animation),
              ),
              m && m.hide());
          } else
            (t &&
                ...
                (m
                  ...
                  : x &&
                    ((i.stateMarkerGraphic = m =
                      d.renderer
                        .symbol(x, g.x, g.y, g.width, g.height, o5(r, n))
                        .add(i.markerGroup)),
                    (m.currentSymbol = x))),
              !d.styledMode &&
                m &&
            ...
            ? (p || (i.halo = p = d.renderer.path().add(b.parentGroup)),
              ...
              p.attr({
                class:
                  ...
                  o6(this.colorIndex, i.colorIndex) +
              ...
              d.styledMode ||
                p.attr(
                  oK(
                    ...
                    eh.filterUserAttributes(y.attributes || {}),
                  ),
                ))
            : p?.point?.haloPath &&
              !p.point.destroyed &&
              p.animate({ d: p.point.haloPath(0) }, null, p.hide),
            oJ(this, "afterSetState", { state: t }));
        }
        haloPath(t) {
          let e = this.pos();
          return e
      ...
      let rt = o7,
        { parse: re } = tG,
        { charts: ri, composed: rs, isTouchDevice: ro } = z,
        {
          addEvent: rr,
          attr: ra,
          css: rn,
      ...
      class ry {
        ...
        destroy() {
          ...
          (this.eventsToUnbind.forEach((t) => t()),
            (this.eventsToUnbind = []),
            !z.chartCount &&
              (ry.unbindDocumentMouseUp.forEach((t) => t.unbind()),
              (ry.unbindDocumentMouseUp.length = 0),
              ry.unbindDocumentTouchEnd &&
                (ry.unbindDocumentTouchEnd = ry.unbindDocumentTouchEnd())),
            rg(t, function (e, i) {
              t[i] = void 0;
            }));
        }
        getSelectionMarkerAttrs(t, e) {
          ...
          return (
            rd(this, "getSelectionMarkerAttrs", i, (i) => {
              let s,
        ...
        drag(t) {
          ...
          if (
            ...
            (this.hasZoom &&
              ...
              e.styledMode ||
                m.attr({ fill: a || re("#334eff").setOpacity(0.25).get() })),
              m && m.attr(l),
              f && !m && c && e.pan(t, o));
          }
        }
        ...
        drop(t) {
          ...
          i &&
            rc(i.index) &&
            (rn(i.container, { cursor: i._cursor }),
        ...
        getChartCoordinatesFromPoint(t, e) {
          ...
          if (i && s) {
            let r = t.clientX ?? t.plotX ?? 0,
              a = t.plotY || 0;
            return (
              t.isNode && o && rc(o.x) && rc(o.y) && ((r = o.x), (a = o.y)),
              e
          ...
          let a = [],
            n = function (t) {
              return (
                t.visible &&
                !(!o && t.directTouch) &&
                rf(t.options.enableMouseTracking, !0)
              );
            },
            h = e,
            l,
          ...
          return (
            ...
            c &&
              (o && !h.noSharedTooltip
                ...
                : a.push(c)),
            rd(this, "afterGetHoverData", (d = { hoverPoint: c })),
        ...
        normalize(t, e) {
          let i = t.touches,
            s = i
              ? i.length
                ? i.item(0)
                : rf(i.changedTouches, t.changedTouches)[0]
              : t;
        ...
        onContainerClick(t) {
          ...
          !e.cancelClick &&
            (i && this.inClass(s.target, "highcharts-tracker")
              ? (rd(i.series, "click", rh(s, { point: i })),
                e.hoverPoint && i.firePointEvent("click", s))
              : (rh(s, this.getCoordinates(s)),
        ...
        onContainerMouseDown(t) {
          ...
          ((t = this.normalize(t)),
            z.isFirefox && 0 !== t.button && this.onContainerMouseMove(t),
            (void 0 === t.button || e) &&
              (this.zoomOption(t),
              e && t.preventDefault?.(),
              this.dragStart(t)));
        ...
        onContainerMouseLeave(t) {
          let { pointer: e } = ri[rf(ry.hoverChartIndex, -1)] || {};
          ((t = this.normalize(t)),
        ...
        onDocumentMouseUp(t) {
          (t?.touches && this.hasPinchMoved && t?.preventDefault?.(),
            ri[rf(ry.hoverChartIndex, -1)]?.pointer?.drop(t));
        }
        pinch(t) {
          let e = this,
          ...
          (a > 1 ? (e.initiated = !0) : l && (e.initiated = !1),
            ...
            "touchstart" === t.type
              ...
              : l
                ...
                : o &&
                  (rd(i, "touchpan", { originalEvent: t, touches: r }, () => {
                    let e = (t) => {
                      let e = t[0],
                        i = t[1] || e;
                      return {
        ...
        runPointActions(t, e, i) {
          ...
          (this.unDocMouseMove ||
            ((this.unDocMouseMove = rr(
              s.container.ownerDocument,
              "mousemove",
              (t) =>
                ri[ry.hoverChartIndex ?? -1]?.pointer?.onDocumentMouseMove(t),
            )),
        ...
        setDOMEvents() {
          ...
          ((t.onmousedown = this.onContainerMouseDown.bind(this)),
            ...
            this.eventsToUnbind.push(
              rr(t, "mouseenter", this.onContainerMouseEnter.bind(this)),
              rr(t, "mouseleave", this.onContainerMouseLeave.bind(this)),
            ),
            ry.unbindDocumentMouseUp.some((t) => t.doc === e) ||
              ry.unbindDocumentMouseUp.push({
                doc: e,
          ...
          for (; s && "BODY" !== s.tagName; )
            (this.eventsToUnbind.push(
              ...
              (s = i(s)));
          (this.eventsToUnbind.push(
            rr(t, "touchstart", this.onContainerTouchStart.bind(this), {
              passive: !1,
            }),
            ...
            rr(this.chart, "redraw", this.setPointerCapture.bind(this)));
        }
        setPointerCapture() {
          if (!ro) return;
          let t = this.pointerCaptureEventsToUnbind,
            ...
            i = e.container,
            s =
              rf(e.options.tooltip?.followTouchMove, !0) &&
              e.series.some(
          ...
          !this.hasPointerCapture && s
            ? (t.push(
              ...
              e.styledMode || rn(i, { "touch-action": "none" }),
        ...
        zoomOption(t) {
          let e = this.chart,
            ...
            o,
            r;
          (/touch/.test(t.type) && (s = rf(e.zooming.pinchType, s)),
      ...
      ((ry.unbindDocumentMouseUp = []),
        ((d = ry || (ry = {})).compose = function (t) {
          rm(rs, "Core.Pointer") &&
            rr(t, "beforeRender", function () {
      ...
      let { setLength: rv, splice: rk } = S,
        { fireEvent: rw, objectEach: rM, uniqueKey: rS } = tn,
        rT = class {
          constructor(t = {}) {
            ((this.autoId = !t.id),
              (this.columns = {}),
          ...
          deleteRows(t, e = 1) {
            ...
            (rw(this, "afterDeleteRows", { rowIndex: t, rowCount: e }),
              (this.versionTag = rS()));
          }
          getColumn(t, e) {
          ...
          setColumns(t, e, i) {
            ...
            (rM(t, (t, e) => {
              ...
              i?.silent ||
                (rw(this, "afterSetColumns"), (this.versionTag = rS())));
          }
          setRow(t, e = this.rowCount, i, s) {
            ...
            (rM(o, (a, n) => {
              (a || s?.addColumns === !1 || (a = Array(r)),
                a &&
                  (i
                    ? (a = rk(a, e, 0, !0, [t[n] ?? null]).array)
                    : (a[e] = t[n] ?? null),
                  (o[n] = a)));
            }),
              r > this.rowCount && this.applyRowCount(r),
              s?.silent ||
                (rw(this, "afterSetRows"), (this.versionTag = rS())));
          }
          getModified() {
      ...
      let rE = T,
        { defaultOptions: rI } = tD,
        { extend: rD, extendClass: rB, merge: rN } = tn;
      var rz = C || (C = {});
      function rR(t, e) {
        ...
        return (
          (o.type = t),
          o.pointClass || (o.pointClass = rt),
          !rz.seriesTypes[t] && (s && (i[t] = s), (rz.seriesTypes[t] = e), !0)
        );
      }
      ((rz.seriesTypes = z.seriesTypes),
        (rz.registerSeriesType = rR),
        (rz.seriesType = function (t, e, i, s, o) {
          let r = rI.plotOptions || {};
          if (
            ((e = e || ""),
            (r[t] = rN(r[e], i)),
            delete rz.seriesTypes[t],
            rR(t, rB(rz.seriesTypes[e] || z.Series, s)),
            (rz.seriesTypes[t].prototype.type = t),
            o)
          ) {
            class e extends rt {}
      ...
      let rW = C,
        { animObject: rH, setAnimation: rX } = t5,
        { defaultOptions: rF } = tD,
        { registerEventOptions: rG } = su,
        { svg: rY, win: rj } = z,
        { seriesTypes: rU } = rW,
        { format: r$ } = eS,
        {
      ...
      class an {
            ...
            (e.axisTypes || []).forEach(function (o) {
              ((s[o] || []).forEach(function (s) {
                ((t = s.options),
                  (ao(i[o], 0) === s.index ||
                    (void 0 !== i[o] && i[o] === t.id)) &&
                    (r8(e, s.series), (e[o] = s), (s.isDirty = !0)));
              }),
        ...
        autoIncrement(t) {
          ...
          if (
            ((this.pointInterval = e =
              ao(this.pointInterval, i.pointInterval, 1)),
            o && at(t) && (e *= t),
            s)
          ) {
            let t = r.toParts(a);
        ...
        setOptions(t) {
          ...
          ((this.tooltipOptions = ai(
            rF.tooltip,
            rF.plotOptions.series?.tooltip,
            c?.tooltip,
          ...
          return (
            (g.negativeColor || g.negativeFillColor) &&
              ...
              u.push(e)),
            u.length &&
              rJ(u[u.length - 1].value) &&
              u.push(a ? {} : { color: this.color, fillColor: this.fillColor }),
            r6(this, "afterSetOptions", { options: g }),
            g
          );
        }
        getName() {
        ...
        getColor() {
          this.chart.styledMode
            ...
            : this.options.colorByPoint
              ...
              : this.getCyclic(
                  "color",
                  this.options.color || rF.plotOptions[this.type].color,
        ...
        getColumn(t, e) {
          return (
            (e ? this.dataTable.getModified() : this.dataTable).getColumn(
              t,
              !0,
            ) || []
          );
        ...
        findPointIndex(t, e) {
          ...
          return (
            ...
            void 0 === o && at(a) && (o = this.getColumn("x").indexOf(a, e)),
            -1 !== o &&
              void 0 !== o &&
              this.cropped &&
              (o = o >= l ? o - l : o),
            !s && at(o) && n[o]?.touched && (o = void 0),
            o
          );
        }
        updateData(t, e) {
          ...
          if (
            ...
            t.forEach((t, e) => {
              let h,
                ...
                { id: c, x: g } = d;
              c || at(g)
                ? (-1 === (h = this.findPointIndex(d, p)) || void 0 === h
                    ? a.push(t)
                    : r[h] && t !== i.data?.[h]
                      ? (r[h].update(t, !1, void 0, !1),
                        (r[h].touched = !0),
                        s && (p = h + 1))
                      : r[h] && (r[h].touched = !0),
                  (!n || e !== h || o?.enabled || this.hasDerivedData) &&
                    (l = !0))
                : a.push(t);
            }, this),
            l)
          ...
          return (
            null !== h &&
              ...
              u.length &&
              ((this.xIncrement = rV(u)), this.autoIncrement()),
            !0
          );
        }
        dataColumnKeys() {
        ...
        setData(t, e = !0, i, s) {
          ...
          if (
            ...
            for (
              ae(this.getColumn("y")[0]) && r2(14, !0, n),
                this.data = [],
        ...
        getProcessedData(t) {
          ...
          return (
            ...
            (m = x.getColumn("x") || []),
            {
              ...
              cropped: c,
              cropStart: p,
              closestPointRange: r9(
                [h ? m.map(h.log2lin) : m],
                () => e.requireSorting && !y && r2(15, !1, e.chart),
              ),
            }
          );
        }
        ...
        cropData(t, e, i) {
          ...
          return { modified: new rT({ columns: r }), start: h, end: l };
        }
        generatePoints() {
          let t = this.options,
          ...
          for (h && n && (this.options.keys = !1), m = 0; m < r; m++)
            ((u = a + m),
              n
                ? (((f = new o(this, i.getRow(m, p) || [])).dataGroup =
                    this.groupMap?.[d + m]),
                  f.dataGroup?.options &&
                    ((f.options = f.dataGroup.options),
                    r3(f, f.dataGroup.options),
                    delete f.dataLabels,
                    (f.key = f.name ?? f.category)))
                : ((f = x[u]),
                  (y = e ? e[u] : i.getRow(m, c)),
                  f || void 0 === y
                    ? f &&
                      ((f.category = this.xAxis?.categories?.[f.x] ?? f.x),
                      (f.key = f.name ?? f.category))
                    : (x[u] = f = new o(this, y, s[m]))),
              f && ((f.index = n ? d + m : u), (l[m] = f)));
          if (((this.options.keys = h), x && (r !== (g = x.length) || n)))
            for (m = 0; m < g; m++)
              (m !== a || n || (m += r),
                x[m] && (x[m].destroyElements(), (x[m].plotX = void 0)));
          ((this.data = x), (this.points = l), r6(this, "afterGeneratePoints"));
        }
        getXExtremes(t) {
          return { min: rZ(t), max: rV(t) };
        }
        getExtremes(t, e) {
          let { xAxis: i, yAxis: s } = this,
            o = e || this.getExtremesFromAll || this.options.getExtremesFromAll,
            r =
              o && this.cropped ? this.dataTable : this.dataTable.getModified(),
            a = r.rowCount,
          ...
          let b = { activeYData: d, dataMin: rZ(d), dataMax: rV(d) };
          return (r6(this, "afterGetExtremes", { dataExtremes: b }), b);
        }
        applyExtremes() {
        ...
        translate() {
          ...
          for (p = 0; p < a; p++) {
            ...
            ((a.plotX = at((g = i.translate(y, !1, !1, !1, !0, n)))
              ? rq(x(g))
              : void 0),
              e &&
                this.visible &&
                ...
                b &&
                  ...
                  ((w = v[0]),
                  (k = v[1]),
                  w === d && f.key === M[y].base && (w = ao(at(l) ? l : o.min)),
                  o.positiveValuesOnly && rJ(w) && w <= 0 && (w = void 0),
                  (a.total = a.stackTotal = ao(b.total)),
                  (a.percentage =
                    rJ(a.y) && b.total ? (a.y / b.total) * 100 : void 0),
                  (a.stackY = k),
              ...
              (a.yBottom = rJ(w) ? x(o.translate(w, !1, !0, !1, !0)) : void 0),
              this.dataModify && (k = this.dataModify.modifyValue(k, p)),
              at(k) && void 0 !== a.plotX
                ? (t = at((t = o.translate(k, !1, !0, !1, !0))) ? x(t) : void 0)
                : !at(k) && c && (t = c),
              (a.plotY = t),
              (a.isInside = this.isPointInside(a)),
              (a.clientX = h ? rq(i.translate(y, !1, !1, !1, !0, n)) : g),
        ...
        afterAnimate() {
          (this.setClip(),
            as(this.chart.sharedClips, (t, e, i) => {
              t &&
        ...
        markerAttribs(t, e) {
          let i = this.options,
            ...
            n,
            h,
            l = ao(o.radius, s?.radius);
          (e &&
            ((n = s.states[e]),
            (h = o.states && o.states[e]),
            (l = ao(h?.radius, n?.radius, l && l + (n?.radiusPlus || 0)))),
        ...
        pointAttribs(t, e) {
          ...
          return (
            ...
            (u = ao(
              ...
              l.lineWidth,
              u + ao(d.lineWidthPlus, l.lineWidthPlus, 0),
            )),
        ...
        destroy(t) {
          let e,
            ...
            a = s.data || [];
          for (
            r6(s, "destroy", { keepEventsForUpdate: t }),
              this.removeEvents(t),
              (s.axisTypes || []).forEach(function (t) {
                ((i = s[t]),
                  i?.series &&
                    (r1(i.series, s), (i.isDirty = i.forceRedraw = !0)));
              }),
          ...
          (tn.clearTimeout(s.animationTimeout),
            as(s, function (t, e) {
              t instanceof it &&
                !t.survive &&
        ...
        searchKDTree(t, e, i, s, o) {
          ...
          if (
            ...
            return (function t(e, i, s, o) {
              ...
              ((l = e[a]),
                (g = b[a]),
                (u = rJ(l) && rJ(g) ? l - g : null),
                (f = e[n]),
                (m = b[n]),
                (x = rJ(f) && rJ(m) ? f - m : 0),
                (y = (d && b.marker?.radius) || 0),
                (b.dist = Math.sqrt(((u && u * u) || 0) + x * x) - y),
                (b.distX = rJ(u) ? Math.abs(u) - y : Number.MAX_VALUE));
              let M =
                  (e[v] || 0) - (b[v] || 0) + ((d && b.marker?.radius) || 0),
                S = M < 0 ? "left" : "right",
                T = M < 0 ? "right" : "left";
              return (
                i[S] && ([k, w] = c(b, t(e, i[S], s + 1, o), h)),
                i[T] &&
                  p(Math.sqrt(M * M), k[h], w) &&
                  (k = c(k, t(e, i[T], s + 1, o), h)[0]),
                k
              );
            })(t, this.kdTree, l, l);
        }
        pointPlacementToXValue() {
          ...
          return (
            ...
            at(i) ? i * (t.pointRange || e.pointRange) : 0
          );
        }
        isPointInside(t) {
        ...
        drawTracker() {
          let t = this,
            ...
            l = "rgba(192,192,192," + (rY ? 1e-4 : 0.002) + ")",
            d = t.tracker;
          (d
            ? d.attr({ d: s })
            : t.graph &&
              ...
              [t.tracker, t.markerGroup, ...(t.dataLabelsGroups || [])].forEach(
                (t) => {
                  t &&
                    (t
                      .addClass("highcharts-tracker")
        ...
        addPoint(t, e, i, s, o) {
          ...
          (d.setRow(f, a, !0, { addColumns: !1 }),
            ...
            i &&
              (l[0] && l[0].remove
                ? l[0].remove(!1)
                : ([l, g].filter(rJ).forEach((t) => {
                    t.shift();
                  }),
                  d.deleteRows(0))),
            !1 !== o && r6(this, "addPoint", { point: f }),
            (this.isDirty = !0),
            (this.isDirtyData = !0),
            e && h.redraw(s));
        }
        ...
        update(t, e) {
          r6(this, "update", { options: (t = r0(t, this.userOptions)) });
          let i = this,
            s = i.chart,
            o = i.userOptions,
          ...
          ((g = g || r),
            u
              ? (p.push.apply(p, an.keepPropsForPoints),
                !1 !== t.visible && p.push("area", "graph"),
                i.parallelArrays.forEach(function (t) {
                  p.push(t + "Data");
                }),
                t.data &&
                  (t.dataSorting && r3(i.options.dataSorting, t.dataSorting),
          ...
          if (rU[g]) {
            if (((f = g !== i.type), i.remove(!1, !1, !1, !0), f))
              if ((s.propFromSeries(), Object.setPrototypeOf))
                Object.setPrototypeOf(i, rU[g].prototype);
              else {
          ...
          } else r2(17, !0, s, { missingModuleFor: g });
          if (
        ...
        onMouseOver() {
          ...
          (i?.setHoverChartIndex(),
            ...
            this.options.events.mouseOver && r6(this, "mouseOver"),
            this.setState("hover"),
            (t.hoverSeries = this));
        }
        onMouseOut() {
          ...
          ((e.hoverSeries = null),
            s && s.onMouseOut(),
            this && t.events.mouseOut && r6(this, "mouseOut"),
            i &&
              !this.stickyTracking &&
        ...
        setState(t, e) {
          ...
          if (
            ((t = t || ""),
            i.state !== t &&
              ([i.group, i.markerGroup, ...(i.dataLabelsGroups || [])].forEach(
                function (e) {
                  e &&
      ...
      ((an.defaultOptions = {
        ...
        (an.types = rW.seriesTypes),
        (an.registerType = rW.registerSeriesType),
        (an.keepProps = [
          "colorIndex",
          "eventOptions",
          "navigatorSeries",
        ...
        (rW.series = an));
      let ah = an,
        { animObject: al, setAnimation: ad } = t5,
        { registerEventOptions: ac } = su,
        { composed: ap, marginNames: ag } = z,
        { distribute: au } = eO,
        { format: af } = eS,
        {
          addEvent: am,
      ...
      class aO {
        constructor(t, e) {
          ((this.allItems = []),
            ...
            e.enabled &&
              (this.render(),
              ac(this, e),
              am(this.chart, "endResize", function () {
        ...
        update(t, e) {
          let i = this.chart;
          (this.setOptions(aS(!0, this.options, t)),
            "events" in this.options && ac(this, this.options),
            this.destroy(),
            (i.isDirtyLegend = i.isDirtyBox = !0),
            aT(e, !0) && i.redraw(),
            aw(this, "afterUpdate", { redraw: e }));
        }
        colorizeItem(t, e) {
          let i = t.color,
            {
          ...
          if (
            ((t instanceof ah || t instanceof rt) &&
          ...
          ((t.color = i),
            aw(this, "afterColorizeItem", { item: t, visible: e }));
        }
        positionItems() {
        ...
        positionItem(t) {
          ...
          if (e?.element) {
            let o = {
              ...
              n = () => {
                aw(this, "afterPositionItem", { item: t });
              };
        ...
        renderItem(t) {
          ...
          (!y &&
            ...
            i.styledMode || y.css(aS(t.visible ? h : l)),
            ...
            !this.baseline &&
              ...
              (this.symbolHeight = aT(o.symbolHeight, this.fontMetrics.f)),
              o.squareSymbol &&
                ((this.symbolWidth = aT(
                  o.symbolWidth,
              ...
              y.css({
                width:
                  Math.min(
                    ...
                    o.maxWidth ? aA(o.maxWidth, i.chartWidth) : 1 / 0,
                  ) -
                  b +
                  "px",
              }),
        ...
        getAllItems() {
          ...
          return (
            this.chart.series.forEach(function (e) {
              let i = e?.options;
              e &&
                aT(i.showInLegend, !ab(i.linkedTo) && void 0, !0) &&
                (t = t.concat(
                  e.legendItem?.labels ||
                    ("point" === i.legendType ? e.data : e),
                ));
            }),
            aw(this, "afterGetAllItems", { allItems: t }),
            t
          );
        }
        getAlignment() {
        ...
        proximatePositions() {
          ...
          au(i, e.plotHeight)))
            ((t = o.item.legendItem || {}),
              aM(o.pos) && (t.y = e.plotTop - e.spacing[0] + o.pos));
        }
        render() {
          let t = this.chart,
          ...
          ((this.itemX = o),
            ...
            (this.offsetWidth = 0),
            (this.lastItemY = 0),
            (this.widthOption = aA(s.width, e - o)),
            (d = e - 2 * o - s.x),
            ...
            (n =
              (s.maxWidth
                ? Math.min(
                    ...
                    d,
                    aA(s.maxWidth, t.chartWidth) || 1 / 0,
                  )
          ...
          return (
            ...
            t && v > 0 && t > v && !1 !== l.enabled
              ? ((this.clipHeight = m =
                ...
                (this.currentPage = aT(this.currentPage, 1)),
                (this.fullHeight = t),
                g.forEach((t, e) => {
        ...
        scroll(t, e) {
          ...
          (l > o && (l = o),
            l > 0 &&
              ...
              aL(
                () => {
                  aw(this, "afterScroll", { currentPage: l });
                },
            ...
            i &&
              i
                ...
                .on("mouseout", function () {
                  (s.chart.styledMode ||
                    e.css(aS(t.visible ? s.itemStyle : s.itemHiddenStyle)),
                    c(""),
                    r.removeClass(h),
                    t.setState());
                })
                .on("click", function (e) {
                  ...
                  (r.removeClass(h),
                    aw(s, "itemClick", { browserEvent: e, legendItem: t }, i),
                    a
                      ? t.firePointEvent("legendItemClick", { browserEvent: e })
                      : n && aw(t, "legendItemClick", { browserEvent: e }));
                });
        }
        createCheckboxForItem(t) {
          ((t.checkbox = ax(
            ...
            am(t.checkbox, "click", function (e) {
              let i = e.target;
              aw(
                t.series || t,
                "checkboxClick",
      ...
      (p = aO || (aO = {})).compose = function (t) {
        aC(ap, "Core.Legend") &&
          am(t, "beforeMargins", function () {
            this.legend = new p(this, this.options.legend);
          });
      };
      let aE = aO,
        { animate: aI, animObject: aD, setAnimation: aB } = t5,
        { defaultOptions: aN } = tD,
        { numberFormat: az } = eS,
        { registerEventOptions: aR } = su,
        { charts: aW, doc: aH, marginNames: aX, svg: aF, win: aG } = z,
        { seriesTypes: aY } = rW,
        {
          addEvent: aj,
          attr: aU,
      ...
      class nn {
        ...
        constructor(t, e, i) {
          this.sharedClips = {};
          const s = [...arguments];
          ((a4(t) || t.nodeName) && (this.renderTo = s.shift()),
            this.init(s[0], s[1]));
        }
        setZoomOptions() {
        ...
        init(t, e) {
          a1(this, "init", { args: arguments }, function () {
            ...
            ((this.userOptions = aQ({}, t)),
              (this.renderTo = a4(o) ? aH.getElementById(o) : o) ||
                aJ(13, !0, this),
              (this.margin = []),
              (this.spacing = []),
              ...
              (this.time = new tA(
                aQ(i.time || {}, { locale: this.locale }),
                i.lang,
              )),
              (i.time = this.time.options),
              (this.numberFormatter = (s.numberFormatter || az).bind(this)),
              (this.styledMode = s.styledMode),
              (this.hasCartesianSeries = s.showAxes),
              (this.index = aW.length),
              aW.push(this),
              z.chartCount++,
              aR(this, s),
              (this.xAxis = []),
        ...
        initSeries(t) {
          let e = this.options.chart,
            i = t.type || e.type,
            s = aY[i];
          s || aJ(17, !0, this, { missingModuleFor: i });
          let o = new s();
        ...
        orderItems(t, e = 0) {
          ...
          if ((this.hasRendered && (s.splice(e), o.splice(e)), i))
            for (let t = e, r = i.length; t < r; ++t) {
              ...
              e &&
                ((e.index = t),
                e instanceof ah && (e.name = e.getName()),
        ...
        getClipBox(t, e) {
          let i = this.inverted,
            { xAxis: s, yAxis: o } = t || {},
            { x: r, y: a, width: n, height: h } = a8(this.clipBox);
          return (
            t &&
        ...
        redraw(t) {
          ...
          (i.forEach(function (t) {
            (t.isDirty &&
              ...
              t.isDirtyData && a1(t, "updatedData"));
          }),
            g &&
              o &&
              o.options.enabled &&
            ...
            e.forEach(function (t) {
              ...
              (t.extKey !== e &&
                ((t.extKey = e),
                h.push(function () {
                  (a1(t, "afterSetExtremes", aQ(t.eventArgs, t.getExtremes())),
                    delete t.eventArgs);
                })),
                (p || d) && t.redraw());
            }),
        ...
        layOutTitles(t = !0) {
          ...
          (["title", "subtitle", "caption"].forEach((t) => {
            let i = this[t],
              ...
              n = i?.textPxLength || 0;
            if (i && r) {
              a1(this, "layOutTitle", { alignTo: a, key: t, textPxLength: n });
        ...
        getChartSize() {
          ...
          ((this.chartWidth = Math.max(0, e || s.width || 600)),
            (this.chartHeight = Math.max(
              0,
              ni(i, this.chartWidth) || (o ? 400 : s.height),
            )),
            (this.containerBox = s));
        }
        temporaryDisplay(t) {
          ...
          if (t)
            for (; e?.style; )
              (e.hcOrigStyle && (aV(e, e.hcOrigStyle), delete e.hcOrigStyle),
                e.hcOrigDetached &&
                  (aH.body.removeChild(e), (e.hcOrigDetached = !1)),
                (e = e.parentNode));
          else
            for (
              ;
              ...
              (aH.body.contains(e) ||
                e.parentNode ||
                ((e.hcOrigDetached = !0), aH.body.appendChild(e)),
              ("none" === a3(e, "display", !1) || e.hcOricDetached) &&
                ((e.hcOrigStyle = {
        ...
        getContainer() {
          let t,
            ...
            r = this.renderTo,
            a = ne(aU(r, s));
          (a6(a) && aW[a] && aW[a].hasRendered && aW[a].destroy(),
            aU(r, s, this.index),
            (r.innerHTML = eh.emptyHTML),
            i.skipClone || r.offsetWidth || this.temporaryDisplay(),
            this.getChartSize());
          let n = this.chartHeight,
            h = this.chartWidth;
          (aV(r, { overflow: "hidden" }),
            this.styledMode ||
              (t = aQ(
                {
                  position: "relative",
          ...
          let l = a$("div", { id: o }, t, r);
          ((this.container = l),
            this.getChartSize(),
            h !== this.chartWidth &&
              ((h = this.chartWidth),
              this.styledMode ||
                aV(l, { width: nt(i.style?.width, h + "px") })),
          ...
          (delete e.pointer?.chartPosition,
            !e.exporting?.isPrinting &&
              ...
              ((s.width !== i.width || s.height !== i.height) &&
                (tn.clearTimeout(e.reflowTimeout),
                (e.reflowTimeout = nr(function () {
        ...
        setChartSize(t) {
          ...
          ((this.plotLeft = e = Math.round(this.plotLeft)),
            ...
            t ||
              ...
              l.alignElements()),
            a1(this, "afterSetChartSize", { skipAxes: t }));
        }
        resetMargins() {
        ...
        propFromSeries() {
          ...
          ["inverted", "angular", "polar"].forEach(function (a) {
            for (
              e = aY[o.type], i = o[a] || (e && e.prototype[a]), t = r?.length;
              !i && t--;
            )
              (e = aY[r[t].type]) && e.prototype[a] && (i = !0);
            s[a] = i;
          });
        }
        linkSeries(t) {
          ...
          (i.forEach(function (t) {
            ...
            i.forEach(function (t) {
              let { linkedTo: s } = t.options,
                o = a4(s) && (":previous" === s ? i[t.index - 1] : e.get(s));
              o &&
                o.linkedParent !== t &&
            ...
            a1(this, "afterLinkSeries", { isUpdating: t }));
        }
        renderSeries() {
          this.series.forEach(function (t) {
          ...
          t)) {
            ...
            if (
              ...
              if (
                (s.destroy(),
                o &&
                  nt(i.reserveSpace, !a6(t.crossing)) &&
                  (r =
                    o.getBBox().height +
                    i.distance +
        ...
        destroy() {
          ...
          for (
            a1(e, "destroy"),
              e.renderer.forExport ? aK(aW, e) : (aW[e.index] = void 0),
              z.chartCount--,
          ...
          ([
            ...
            o && ((o.innerHTML = eh.emptyHTML), ns(o), r && aq(o)),
            a7(e, function (t, i) {
              delete e[i];
            }));
        }
        ...
        warnIfCSSNotLoaded() {
          this.styledMode &&
            "0" !== aG.getComputedStyle(this.container).zIndex &&
            aJ(35, !1, this);
        }
        addSeries(t, e, i) {
          let s,
          ...
          return (
            t &&
              ((e = nt(e, !0)),
              a1(o, "addSeries", { options: t }, function () {
                ((s = o.initSeries(t)),
                  (o.isDirtyLegend = !0),
                  o.linkSeries(),
                  s.enabledDataSorting && s.setData(t.data, !1),
                  a1(o, "afterAddSeries", { series: s }),
                  e && o.redraw(i));
              })),
            s
          );
        ...
        showLoading(t) {
          ...
          (r ||
            ...
            a ||
              ((e.loadingSpan = a =
                a$("span", { className: "highcharts-loading-inner" }, null, r)),
              aj(e, "redraw", o)),
            (r.className = "highcharts-loading"),
            eh.setElementHTML(a, nt(t, i.lang.loading, "")),
            !e.styledMode &&
              (aV(r, aQ(s.style, { zIndex: 10 })),
              aV(a, s.labelStyle),
              e.loadingShown ||
                (aV(r, { opacity: 0, display: "" }),
                aI(
                  r,
        ...
        update(t, e, i, s) {
          let o,
            ...
            d = [];
          (a1(n, "update", { options: t }),
            l || n.setResponsive(!1, !0),
            (t = a_(t, n.options)),
            (n.userOptions = a8(n.userOptions, t)));
          let c = t.chart;
          (c &&
            (a8(!0, n.options.chart, c),
            this.setZoomOptions(),
                ...
                (no(t[e]).forEach(function (t, s) {
                  ...
                  (r && (o = n.get(t.id)),
                    !o &&
                      n[e] &&
                      (o = n[e][nt(t.index, s)]) &&
                      ((r && aZ(o.options.id)) || o.options.isInternal) &&
                      (o = void 0),
                    o &&
                      o.coll === e &&
          ...
          let p = c?.width,
            g =
              c && (a4(c.height) ? ni(c.height, p || n.chartWidth) : c.height);
          (a || (a6(p) && p !== n.chartWidth) || (a6(g) && g !== n.chartHeight)
            ? n.setSize(p, g, s)
            : nt(e, !0) && n.redraw(s),
            a1(n, "afterUpdate", { options: t, redraw: e, animation: s }));
        }
        setSubtitle(t, e) {
        ...
        zoomOut() {
          a1(this, "selection", { resetSelection: !0 }, () =>
        ...
        transform(t) {
          ...
          for (let t of e) {
            let {
              ...
              v = nt(a[y], t.len),
              k = nt(s[y], t.len),
              w = 10 > Math.abs(v) ? 1 : v / k,
              M = (s[b] || 0) + k / 2 - t.pos,
              S = M - ((a[b] ?? t.pos) + v / 2 - t.pos) / w,
              T = (x && !l) || (!x && l) ? -1 : 1;
            ...
            let {
              ...
              H = D ?? R,
              X = O - L,
              F = t.categories ? 0 : Math.min(X, H - W),
              G = W - F * (aZ(z) ? 0 : m.minPadding),
              Y = H + F * (aZ(R) ? 0 : m.maxPadding),
              j = t.allowZoomOutside || 1 === w || ("zoom" !== n && w > 1),
              U = Math.min(z ?? G, G, j ? B : G),
              $ = Math.max(R ?? Y, Y, j ? N : Y);
            (!t.isOrdinal || 1 !== w || o) &&
              (L < U && ((L = U), w >= 1 && (O = L + X)),
              O > $ && ((O = $), w >= 1 && (L = O - X)),
              (o ||
                (t.series.length &&
                  ...
                  O <= $)) &&
                (r
                  ? r[t.coll].push({ axis: t, min: L, max: O })
                  : ((t.isPanning = "zoom" !== n),
                    t.isPanning && "mousewheel" !== n && (g = !0),
                    t.setExtremes(o ? void 0 : L, o ? void 0 : O, !1, !1, {
                      move: S,
                      trigger: n,
                      scale: w,
                    }),
      ...
      function nx() {
        ...
        ((this.scrollablePixelsX || this.scrollablePixelsY) &&
          !t &&
          (this.scrollablePlotArea = t = new nb(this)),
          t?.applyFixed());
      }
      function ny() {
      ...
      class nb {
        static compose(t, e, i) {
          nm(nl, this.compose) &&
            (nd(t, "afterInit", ny),
            nd(e, "afterSetChartSize", (t) => this.afterSetSize(t.target, t)),
            nd(e, "render", nx),
            nd(i, "show", ny));
        }
            ...
            if (
              (r
                ? ((t.scrollablePixelsX = i = Math.max(0, r - t.chartWidth)),
                  i &&
                    ((t.scrollablePlotBox = nf(t.plotBox)),
        ...
        constructor(t) {
          ...
          (t.scrollablePixelsX && (a.overflowX = "auto"),
            ...
            (this.chart = t));
          const n = (this.parentDiv = nc(
              "div",
              { className: "highcharts-scrolling-parent" },
              { position: "relative" },
              t.renderTo,
            )),
            h = (this.scrollingContainer = nc(
              "div",
              { className: "highcharts-scrolling" },
              a,
              n,
            )),
            l = (this.innerContainer = nc(
              "div",
          ...
          ((this.mask = c
            ...
            np(t.renderTo, { overflow: "visible" }),
            nd(t, "afterShowResetZoom", r),
            nd(t, "afterApplyDrilldown", r),
            nd(t, "afterLayOutTitles", r),
            nd(h, "scroll", () => {
          ...
          setOffset(t, e, i, s, o, r) {
            ...
            if (h && p) {
              ...
              ((p.x -= o),
                ...
                i &&
                  nk.prototype.justifyDataLabel.call(
                    n,
                    h,
                    a,
                    h.alignAttr,
            ...
            nM(this, "afterSetOffset", { xOffset: t, width: e });
          }
      ...
      function nU(t, e) {
        ...
        for (k.stacksTouched += 1, h = 0; h < g; h++) {
          ...
          ("percent" === l
            ...
            "group" === l
              ? (o.cumulative = (S || 1) - 1)
              : (o.cumulative = nE(nR(o.cumulative, m) + u)),
            (o.total = S),
            null !== g &&
      ...
      class n$ {
        ...
        resetStacks() {
          nz(this.stacks, (t) => {
            nz(t, (e, i) => {
              nN(e.touched) && e.touched < this.stacksTouched
      ...
      (A || (A = {})).compose = function (t, e, i) {
        ...
        s.getStacks ||
          ...
          nO(t, "destroy", nH),
          (s.getStacks = nW),
          (o.getStackIndicator = nF),
          (o.modifyStacks = nG),
          (o.percentStacker = nY),
          (o.setGroupedPoints = nj),
          (o.setStackedPoints = nU));
      };
      let nV = A,
        { defined: nZ, merge: n_, isObject: nq } = tn;
      class nK extends ah {
        drawGraph() {
          let t = this.options,
      ...
      let {
        ...
        { extend: nQ, merge: n0, objectEach: n1, pick: n2 } = tn;
      class n3 extends nJ {
        drawGraph() {
            ...
            (a ||
              (t[o].leftCliff =
                ...
                t[o].rightNull =
                  void 0),
              (i = t[o].isNull),
              (e = n2(t[o].rectPlotX, t[o].plotX)),
              (s = a ? n2(t[o].yBottom, g) : g),
              (!i || u) &&
                (u || f(o, o - 1, "left"),
                (i && !a && u) ||
      ...
      ((n3.defaultOptions = n0(nJ.defaultOptions, {
        ...
        nQ(n3.prototype, { singleStacks: !1 }),
        rW.registerSeriesType("area", n3));
      let { line: n5 } = rW.seriesTypes,
        { merge: n6, pick: n9 } = tn;
      class n4 extends n5 {
        getPointSpline(t, e, i) {
          ...
          let p = [
            "C",
            n9(l.rightContX, l.plotX, 0),
            n9(l.rightContY, l.plotY, 0),
            n9(s, n, 0),
            n9(o, h, 0),
            n,
            h,
      ...
      ((n4.defaultOptions = n6(n5.defaultOptions)),
        rW.registerSeriesType("spline", n4));
      let n8 = n4,
        {
          area: n7,
          area: { prototype: ht },
        } = rW.seriesTypes,
        { extend: he, merge: hi } = tn;
      class hs extends n8 {}
      ((hs.defaultOptions = hi(n8.defaultOptions, n7.defaultOptions)),
        he(hs.prototype, {
      ...
      class hx extends ah {
        animate(t) {
          ...
          t && h
            ? ((d.scaleY = 0.001),
              (i = hn(o.toPixels(n.threshold || 0), r, r + o.len)),
              l
                ? (d.translateX =
        ...
        getColumnMetrics() {
          ...
          let l = Math.min(
            ...
            p = Math.min(
              ...
              hf(e.pointWidth, c * (1 - 2 * e.pointPadding)),
            ),
            g = (t.columnIndex || 0) + +!!r;
          return (
            (t.columnMetrics = {
        ...
        crispCol(t, e, i, s) {
          ...
          return (
            (s = hh(e + s, o, r) - (e = hh(e, o, r))),
            this.options.crisp && (i = hh(t + i, o) - (t = hh(t, o))),
        ...
        translate() {
          ...
          (i.pointPadding && i.crisp && (f = Math.ceil(f)),
            ah.prototype.translate.apply(t),
        ...
        pointAttribs(t, e) {
          ...
          (t &&
            ...
            e &&
              t &&
              ((h = (a = hu(i.states[e], t.options.states?.[e] || {}))
                .brightness),
              (l =
                a.color ||
                (void 0 !== h && hr(l).brighten(a.brightness).get()) ||
                l),
              (d = a[o] || d),
              (p = a[r] || p),
              (c = a.dashStyle || c),
      ...
      !(function (t) {
        ...
        function i(t, e, i, s, o) {
          let { chart: r, enabledDataSorting: a } = this,
            ...
            p = 0 === d && "justify" === hL(i.overflow, a ? "none" : "justify"),
            g =
              this.visible &&
              !1 !== t.visible &&
              hk(h) &&
              (t.series.forceDL ||
                (a && !p) ||
                c ||
                (hL(i.inside, !!this.options.stacking) &&
                  s &&
          ...
          if (g && u) {
            ...
            if (
              ...
              hw(i, { width: h.width, height: h.height }),
              (f = s),
              a && this.xAxis && !p && this.setDataLabelStartPos(t, e, o, c, f),
              e.align(hA(i, { width: l.width, height: l.height }), !1, s, !1),
              (e.alignAttr.x += hS(i.align) * (l.width - h.width)),
              (e.alignAttr.y += hS(i.verticalAlign) * (l.height - h.height)),
        ...
        function r(t) {
          ...
          let i = this,
            ...
            u = g ? hb(s, p, i) : { defer: 0, duration: 0 };
          (hM(this, "drawDataLabels"),
            i.hasDataLabels?.() &&
              t.forEach((t) => {
                let a = t.dataLabels || [],
                  h = t.color || i.color;
                hE(n(c, t.dlOptions || t.options?.dataLabels)).forEach(
                  (n, l) => {
                    ...
                    let c =
                      ...
                      M;
                    (c &&
                      ((y = hk((x = hL(n[t.formatPrefix + "Format"], n.format)))
                        ? hv(x, t, s)
                      ...
                      !s.styledMode &&
                        ((m.color = hL(
                          n.color,
                          m.color,
                          hC(i.color) ? i.color : void 0,
                          "#000000",
                        )),
                        "contrast" === m.color
                          ? ("none" !== p && (M = p),
                            (t.contrastColor = r.getContrast(
                              ("auto" !== M && hC(M) && M) || (hC(h) ? h : ""),
                            )),
                            (m.color =
                              M ||
                              (!hk(f) && n.inside) ||
                      ...
                      s.styledMode ||
                        ((v.fill = "auto" === p ? t.color : p),
                        (v.stroke = "auto" === g ? t.color : g),
                      ...
                      !k ||
                        (c &&
                          hk(y) &&
                          !!(k.div || k.text?.foreignObject) == !!n.useHTML &&
                          ((k.rotation && n.rotation) ||
                            k.rotation === n.rotation)) ||
                        ((k = void 0), (w = !0)),
                      c &&
                        hk(y) &&
                        ...
                        k &&
                          ...
                          hM(k, "beforeAddingDataLabel", {
                            labelOptions: n,
                            point: t,
                          }),
                          k.added || k.add(e),
                          i.alignDataLabel(t, k, n, void 0, w),
                          (k.isActive = !0),
      ...
      function hR(t, e, i, s, o) {
        ...
        (i.align ?? (i.align = !n || p ? "center" : c ? "right" : "left"),
          ...
          hB.prototype.alignDataLabel.call(this, t, e, i, s, o),
          i.inside && t.contrastColor && e.css({ color: t.contrastColor }));
      }
      (L || (L = {})).compose = function (t) {
        (hI.compose(hB),
          hz(hD, "ColumnDataLabel") && (t.prototype.alignDataLabel = hR));
      };
      let hW = L,
        { extend: hH, merge: hX } = tn;
      class hF extends hy {}
      ((hF.defaultOptions = hX(hy.defaultOptions, {})),
        hH(hF.prototype, { inverted: !0 }),
        rW.registerSeriesType("bar", hF));
      let { column: hG, line: hY } = rW.seriesTypes,
        { addEvent: hj, extend: hU, merge: h$ } = tn;
      class hV extends hY {
        applyJitter() {
          let t = this,
                ...
                if (e[r] && !s.isNull) {
                  ...
                  if (h && !h.logarithmic) {
                    ...
                    ((s[n] =
                      e +
                      (d - e) *
                        ((t = 1e4 * Math.sin(o + a * i)) - Math.floor(t))),
      ...
      let { deg2rad: hZ } = z,
        { fireEvent: h_, isNumber: hq, pick: hK, relativeLength: hJ } = tn;
      (((g = O || (O = {})).getCenter = function () {
        ...
        let g = [
          hK(r?.[0], "50%"),
          hK(r?.[1], "50%"),
          hK(l && l < 0 ? void 0 : t.size, "100%"),
          hK(d && d < 0 ? void 0 : t.innerSize || 0, "0%"),
        ];
        for (!e.angular || this instanceof ah || (g[3] = 0), c = 0; c < 4; ++c)
          ((p = g[c]),
            (h = c < 2 || (2 === c && /%$/.test(p))),
            (g[c] = hJ(p, [s, o, a, g[2]][c]) + (h ? i : 0)));
        return (
          g[3] > g[2] && (g[3] = g[2]),
          hq(n) && 2 * n < g[2] && n > 0 && (g[3] = g[2] - 2 * n),
          h_(this, "afterGetCenter", { positions: g }),
          g
        );
      }),
        (g.getStartAndEndRadians = function (t, e) {
          ...
          return { start: hZ * (i + -90), end: hZ * (s + -90) };
        }));
      let hQ = O,
        { setAnimation: h0 } = t5,
        {
      ...
      class h4 extends rt {
        ...
        slice(t, e, i) {
          ...
          (h0(i, s.chart),
            (e = h6(e, !0)),
            (this.sliced = this.options.sliced = t = h2(t) ? t : !this.sliced),
      ...
      let { getStartAndEndRadians: h8 } = hQ,
        { noop: h7 } = z,
        { clamp: lt, extend: le, fireEvent: li, merge: ls, pick: lo } = tn;
      class lr extends ah {
        animate(t) {
          let e = this,
            i = e.points,
      ...
      !(function (t) {
        ...
        function s() {
          ...
          t.visible &&
            ...
            ll.prototype.drawDataLabels.apply(t),
            e.forEach((t) => {
            ...
            (0 === ld(c) || this.verifyDataLabelOverflow(c)) &&
                    ...
                    ((g = s.connector),
                      n && n.distance > 0
                        ? ((h = !g),
                          ...
                          g.attr({ visibility: n.attribs?.visibility }))
            ...
            !a &&
              (null !== s[0]
                ...
                : ((r = Math.max(e[2] - t[1] - t[3], o)),
                  (e[0] += (t[3] - t[1]) / 2)),
              null !== s[1]
                ? (r = lc(r, o, e[2] - Math.max(t[0], t[2])))
                : ((r = lc(r, o, e[2] - t[0] - t[2])),
                  (e[1] += (t[0] - t[2]) / 2)),
              r < e[2]
                ? ((e[2] = r),
                  (e[3] = Math.min(
      ...
      (((u = I || (I = {})).getCenterOfPoints = function (t) {
        ...
        (u.pointInPolygon = function ({ x: t, y: e }, i) {
          let s = i.length,
            o,
            r,
            a = !1;
            ...
            t.oldOpacity !== i &&
              (t.hasClass("highcharts-data-label")
                ? (t[i ? "removeClass" : "addClass"](
                  ...
                  lk(e, "afterHideOverlappingLabel"))
                : t.attr({ opacity: i })),
            (t.isOld = !0)),
          s
        );
      }
      let { defaultOptions: lT } = tD,
        { noop: lC } = z,
        {
          addEvent: lA,
          extend: lP,
        ...
        lI = { radius: 0, scope: "stack", where: void 0 },
        lD = lC,
        lB = lC;
      ...
      function lz() {
        if (
          ...
          let { options: t, yAxis: e } = this,
            ...
            s = lT.plotOptions?.[this.type]?.borderRadius,
            o = lR(t.borderRadius, lL(s) ? s : {}),
          ...
          for (let s of this.points) {
            ...
            if ("roundedRect" === s.shapeType && a) {
              ...
              (!g &&
                ...
                g || (g = "end"));
              let u =
                Math.min(lE(o.radius, n), n / 2, "all" === g ? h / 2 : 1 / 0) ||
                0;
              ("end" === g && (p && (d -= u), (c += u)),
                lP(a, { brBoxHeight: c, brBoxY: d, r: u }));
            }
          }
        }
      }
      function lR(t, e) {
        return (lL(t) || (t = { radius: t || 0 }), lO(lI, e, t));
      }
      function lW() {
      ...
      function l$(t, e) {
        ...
        (
          ...
          function () {
            return (
              this.chartWidth <= lj(i.maxWidth, Number.MAX_VALUE) &&
              this.chartHeight <= lj(i.maxHeight, Number.MAX_VALUE) &&
              this.chartWidth >= lj(i.minWidth, 0) &&
              this.chartHeight >= lj(i.minHeight, 0)
            );
          }
      ...
      function lV(t, e) {
        ...
        !e &&
          ...
          i.rules &&
          i.rules.forEach((t) => {
            (void 0 === t._id && (t._id = lU()),
              this.matchResponsiveRule(t, o));
          }, this);
        let a = lY(
          ...o
            .map((t) => lG(i?.rules || [], (e) => e._id === t))
      ...
      (D || (D = {})).compose = function (t) {
        ...
        return (
          e.matchResponsiveRule ||
            lF(e, { matchResponsiveRule: l$, setResponsive: lV }),
          t
        );
      };
      let lZ = D;
      ((z.AST = eh),
        ...
        (z.Time = tA),
        (z.Tooltip = oj),
        (z.animate = t5.animate),
        (z.animObject = t5.animObject),
        (z.chart = nn.chart),
        (z.color = tG.parse),
        (z.dateFormat = eS.dateFormat),
        (z.defaultOptions = tD.defaultOptions),
        (z.distribute = eO.distribute),
        (z.format = eS.format),
        (z.getDeferredAnimation = t5.getDeferredAnimation),
        (z.getOptions = tD.getOptions),
        (z.numberFormat = eS.numberFormat),
        (z.seriesType = rW.seriesType),
        (z.setAnimation = t5.setAnimation),
        (z.setOptions = tD.setOptions),
        (z.stop = t5.stop),
        (z.time = tD.defaultTime),
        (z.timers = tV.timers),
        {
          compose: function (t, e, i) {
            ...
            if (!e.symbolCustomAttribs.includes("borderRadius")) {
              ...
              (lA(t, "afterColumnTranslate", lz, { order: 9 }),
                lA(s, "afterTranslate", lW),
          ...
          optionsToObject: lR,
        }.compose(z.Series, z.SVGElement, z.SVGRenderer),
        hW.compose(z.Series.types.column),
        hI.compose(z.Series),
        s7.compose(z.Axis),
        sn.compose(z.SVGRenderer),
        aE.compose(z.Chart),
        os.compose(z.Axis),
        (r = (f = z.Chart).prototype).hideOverlappingLabels ||
          ((r.hideOverlappingLabels = function (t) {
            let e = t.length,
              i = (t, e) =>
                !(
                  e.x >= t.x + t.width ||
              ...
              s = (t, e) => {
                for (let i of t) if (ly({ x: i[0], y: i[1] }, e)) return !0;
                return !1;
              },
              o,
              r,
        ...
        lx.compose(z.Series.types.pie),
        oy.compose(z.Chart, z.Axis),
        rb.compose(z.Chart),
        lZ.compose(z.Chart),
        nb.compose(z.Axis, z.Chart, z.Series),
        nV.compose(z.Axis, z.Chart, z.Series),
        oj.compose(z.Pointer),
        tn.extend(z, tn));
      let l_ = z;
      return N.default;
    })(),
